  ...
  useEffect(()=> {
    ...
    const isFormUpdated = () => {
        ...
        if(currentValues.courseTitle !== course.courseName || 
            ...
            currentValues.courseBenefits !== course.courseBenefits ||
    ...
    const onSubmit = async(data) => {
        if(editCourse){
            ...
            if(currentValues.courseCategory._id !== course.category._id){
                formData.append("category",data.courseCategeory);
            }
    ...
    >
        <div className="flex flex-col space-y-2">
            ...
            />
            {
             ...
             <div className="flex flex-col space-y-2">
                <label className="text-sm text-richblack-5" htmlFor='courseShortDesc'>Course Short Description<span className="text-pink-200">*</span></label>
                <textarea 
                id='courseShortDesc'
