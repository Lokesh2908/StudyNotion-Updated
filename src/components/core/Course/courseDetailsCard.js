...
export const CourseDetailsCard = ({course, setConfirmationModal, handleBuyCourse}) => {
    ...
    const handleShare = () => {
        ...
        toast.success("Link copied to clipoard");
    }

    return (
        <>
    <div className={`flex flex-col gap-4 rounded-md bg-richblack-700 p-4 text-richblack-5`}>
        <img src={ThumbnailImage} alt={course?.courseName} className='max-h-[300px] min-h-[180px] w-[400px] overflow-hidden rounded-2xl object-cover md:max-w-full'></img>
        <div className="px-4">
